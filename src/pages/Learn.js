...
function Learn() {
  ...
  return (
    <Container maxWidth="md" style={{ marginTop: "2rem" }}>
      ...
      {state.isLoading ? (
        <div style={{ display: "flex", justifyContent: "center", height: "80vh", flexDirection: "column" }}>
          ...
          {data.length > 0 &&
            data.map((set) => (
              <Grid item xs={6} md={4} key={set.id}>
                <Card style={{ backgroundColor: set.score === 10 ? "#ffff00" : "#fff" }}>
                  <CardContent>
                    <Typography
                      variant="h5"
                      component="div"
                    ...
                    <Typography
                      sx={{ mb: 1.5, fontFamily: "'Fira Sans', sans-serif" }}
                      color="#ff6f00"
                    >
